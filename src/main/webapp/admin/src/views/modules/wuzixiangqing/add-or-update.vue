  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wuzibianhao" label="物资编号" prop="wuzibianhao">
              <el-input v-model="ruleForm.wuzibianhao" 
                placeholder="物资编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体积" prop="tiji">
          <el-input v-model="ruleForm.tiji" 
              placeholder="体积" clearable  :readonly="ro.tiji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体积" prop="tiji">
              <el-input v-model="ruleForm.tiji" 
                placeholder="体积" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.rukushijian" label="入库时间" prop="rukushijian">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="状态" prop="zhuangtai">
          <el-input v-model="ruleForm.zhuangtai" 
              placeholder="状态" clearable  :readonly="ro.zhuangtai"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="存放温度" prop="cunfangwendu">
          <el-input v-model="ruleForm.cunfangwendu" 
              placeholder="存放温度" clearable  :readonly="ro.cunfangwendu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="存放温度" prop="cunfangwendu">
              <el-input v-model="ruleForm.cunfangwendu" 
                placeholder="存放温度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="仓位信息" prop="cangweixinxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.cangweixinxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cangweixinxi" label="仓位信息" prop="cangweixinxi">
                    <span v-html="ruleForm.cangweixinxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.shengchanriqi = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='cangweixinxi'){
            this.ruleForm.cangweixinxi = obj[o];
	    this.ro.cangweixinxi = true;
            continue;
          }
          if(o=='tiji'){
	    ...
	    this.ro.weizhi = true;
          ...
          if(o=='cunfangwendu'){
            this.ruleForm.cunfangwendu = obj[o];
	    this.ro.cunfangwendu = true;
            continue;
          }
          if(o=='shengchanriqi'){
	...
	this.ruleForm.cangweixinxi = this.ruleForm.cangweixinxi.replace(reg,'../../../ssmr46x1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wuzixiangqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wuzixiangqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
