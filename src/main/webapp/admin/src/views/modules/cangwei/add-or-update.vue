<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="序列号" prop="xuliehao">
            <el-input v-model="ruleForm.xuliehao" 
                placeholder="序列号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xuliehao" label="序列号" prop="xuliehao">
              <el-input v-model="ruleForm.xuliehao" 
                placeholder="序列号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物资编号" prop="wuzibianhao">
          <el-input v-model="ruleForm.wuzibianhao" 
              placeholder="物资编号" clearable  :readonly="ro.wuzibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物资编号" prop="wuzibianhao">
              <el-input v-model="ruleForm.wuzibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="对应仓库号" prop="duiyingcangkuhao">
          <el-input v-model="ruleForm.duiyingcangkuhao" 
              placeholder="对应仓库号" clearable  :readonly="ro.duiyingcangkuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="对应仓库号" prop="duiyingcangkuhao">
              <el-input v-model="ruleForm.duiyingcangkuhao" 
                placeholder="对应仓库号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="长度" prop="zhangdu">
          <el-input v-model="ruleForm.zhangdu" 
              placeholder="长度" clearable  :readonly="ro.zhangdu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="长度" prop="zhangdu">
              <el-input v-model="ruleForm.zhangdu" 
                placeholder="长度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="仓位详情" prop="cangweixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.cangweixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cangweixiangqing" label="仓位详情" prop="cangweixiangqing">
                    <span v-html="ruleForm.cangweixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	wuzibianhao : false,
	wuzimingcheng : false,
	duiyingcangkuhao : false,
	zhuangtai : false,
	zhangdu : false,
	cangweixiangqing : false,
      },
      ruleForm: {
        xuliehao: this.getUUID(),
        wuzibianhao: '',
        wuzimingcheng: '',
        duiyingcangkuhao: '',
        zhuangtai: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='xuliehao'){
            this.ruleForm.xuliehao = obj[o];
	    this.ro.xuliehao = true;
            continue;
          }
          if(o=='wuzibianhao'){
            this.ruleForm.wuzibianhao = obj[o];
	    this.ro.wuzibianhao = true;
            continue;
          }
          if(o=='wuzimingcheng'){
	    ...
	    this.ro.wuzimingcheng = true;
          ...
          if(o=='duiyingcangkuhao'){
            this.ruleForm.duiyingcangkuhao = obj[o];
	    this.ro.duiyingcangkuhao = true;
            continue;
          }
          if(o=='zhuangtai'){
	    ...
	    this.ro.zhuangtai = true;
          ...
          if(o=='zhangdu'){
            this.ruleForm.zhangdu = obj[o];
	    this.ro.zhangdu = true;
            continue;
          }
          if(o=='cangweixiangqing'){
            this.ruleForm.cangweixiangqing = obj[o];
	    this.ro.cangweixiangqing = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.zhuangtaiOptions = "已占用,未占用,已占满,未占满".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.cangweixiangqing = this.ruleForm.cangweixiangqing.replace(reg,'../../../ssmr46x1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cangwei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cangweiCrossAddOrUpdateFlag = false;
						 this.parent.search();
