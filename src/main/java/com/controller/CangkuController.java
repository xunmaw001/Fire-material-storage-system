...
public class CangkuController {
    ...
    public R page(@RequestParam Map<String, Object> params,CangkuEntity cangku, 
        ...
        EntityWrapper<CangkuEntity> ew = new EntityWrapper<CangkuEntity>();
    ...
    public R save(@RequestBody CangkuEntity cangku, HttpServletRequest request){
    	cangku.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<CangkuEntity> wrapper = new EntityWrapper<CangkuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = cangkuService.selectCount(wrapper);
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<CangkuEntity> ew = new EntityWrapper<CangkuEntity>();
        List<Map<String, Object>> result = cangkuService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<CangkuEntity> ew = new EntityWrapper<CangkuEntity>();
        List<Map<String, Object>> result = cangkuService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<CangkuEntity> ew = new EntityWrapper<CangkuEntity>();
        List<Map<String, Object>> result = cangkuService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
